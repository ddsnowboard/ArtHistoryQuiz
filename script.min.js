...
var current=0;cards=old.concat(after).slice();current_set="all";var side="front";draw(current,side);console.log("Ran code");$("#left").click(function(){if(current!==0){current--;}else{current=cards.length-1;}
