...
var current=0;cards=old.concat(after).slice();current_set="all";var side="front";$(".tall").css("height",$(window).height()*.85);$("img").css("max-height",$(window).height()*.60);draw(current,side);$("#left").click(function(){if(current!==0){current--;}else{current=cards.length-1;}
